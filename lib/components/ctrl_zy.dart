...
//   if (_currentIndex < state.length && state[_currentIndex].isNotEmpty) {
//     state = [
//       ...state.take(_currentIndex + 1),
//       [
//         ...state[_currentIndex],
//         if (state[_currentIndex].last.isNotEmpty)
...
class LinesNotifier extends StateNotifier<List<List<Offset>>> {
  ...
  List<List<Offset>> get currentLines => state;
}